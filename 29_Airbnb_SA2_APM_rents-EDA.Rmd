...
max <- max(max(APM_sa2[APM_sa2$property_type == "House",]$rent_50p_int),
           max(APM_sa2[APM_sa2$property_type == "House",]$awr_50p_int))
...
animate(anime, height = 1000, width = 1600)
anim_save("./plot/apm_rent_animated_house_ste_facet.gif")

max <- max(max(APM_sa2[APM_sa2$property_type == "Unit",]$rent_50p_int),
           max(APM_sa2[APM_sa2$property_type == "Unit",]$awr_50p_int))
...
animate(anime, height = 1000, width = 1600)
anim_save("./plot/apm_rent_animated_unit_ste_facet.gif")
