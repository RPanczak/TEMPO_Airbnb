...
# ########################################
# ####
f1 = cumulative ~ f(time, model = "ar1", hyper = lgprior2) + 
...
# ####
f2 = cumulative ~ f(time, model = "ar1", hyper = lgprior2) + 
  f(SA2_MAIN16, model="iid", param = prior.nu) + 
  as.factor(IRSD_d)
...
f3 = cumulative ~ 
  f(time,   IRSD_d_1,  model = "ar1", hyper = lgprior2) + 
  f(time2,  IRSD_d_2,  model = "ar1", hyper = lgprior2) + 
  f(time3,  IRSD_d_3,  model = "ar1", hyper = lgprior2) + 
  f(time4,  IRSD_d_4,  model = "ar1", hyper = lgprior2) + 
  f(time5,  IRSD_d_5,  model = "ar1", hyper = lgprior2) + 
  f(time6,  IRSD_d_6,  model = "ar1", hyper = lgprior2) + 
  f(time7,  IRSD_d_7,  model = "ar1", hyper = lgprior2) + 
  f(time8,  IRSD_d_8,  model = "ar1", hyper = lgprior2) + 
  f(time9,  IRSD_d_9,  model = "ar1", hyper = lgprior2) + 
  f(time10, IRSD_d_10, model = "ar1", hyper = lgprior2) + 
  f(SA2_MAIN16, model="iid", param = prior.nu) + 
  as.factor(IRSD_d)
...
saveRDS(m3, file = "./res/INLA/06/m3.rds")

# m1 <- readRDS(file = "./res/INLA/06/m1.rds")
# m2 <- readRDS(file = "./res/INLA/06/m2.rds")
# m3 <- readRDS(file = "./res/INLA/06/m3.rds")
