...
write_csv(airbnb_sa4_month, "./conversation/fig_1_sa4_month.csv")
...
SA2_centr %>% 
  st_drop_geometry() %>% 
  write_csv("./conversation/fig_2_SA2_centr.csv")

airbnb_month_list <- readRDS("./conversation/airbnb_month_list.Rds")

write_csv(airbnb_month_list, "./conversation/fig_3_month_list.csv")
```
