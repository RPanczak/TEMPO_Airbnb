...
comma(length(unique(monthly_new_prep_revenue$property_id)))
...
# View(filter(monthly_new_prep_revenue, property_id == 14999741))
# Luxury 80ft Motor Yacht - 4 Bedroom
# $6,990.00 per night

# View(filter(monthly_new_prep_revenue, property_id == 30109331))
...
View(filter(property_new, property_id == 27554784))
View(filter(monthly_new_prep_revenue, property_id == 27554784))
...
Apart from properties that are inactive but have some revenue? or have `available_days` > 0? 
