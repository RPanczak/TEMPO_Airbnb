...
monthly_select %<>% 
  dplyr::filter(!property_id %in% unique(remote_monthly$property_id))
```
...
rm(zero_res, remote_monthly, zero_days, monthly_select, property_select, max_guests_1, max_guests_2)
gc()
```
