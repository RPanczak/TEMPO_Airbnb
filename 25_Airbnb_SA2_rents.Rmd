...
library(pacman) 
p_load(tidyverse, magrittr, lubridate, scales, readxl, janitor, tor,
       sf, tmap, tmaptools, 
...
meta <- fromJSON("data/APM/raw/metadata2793132371468489719.json") %>% 
  as_data_frame() %>% 
  unnest_wider()
...
p_load(openxlsx)
write.xlsx(data3820838135827254920, "data/APM/raw/data3820838135827254920.xlsx")
...
table(data3820838135827254920$For_Rent_Home_Lease_PriceCalculationRecordCount - data3820838135827254920$For_Rent_Home_Lease_DetailedPriceCalculationRecordCount)
