...
frq(SA1$SA4_GCC_NAME16)
length(unique(SA1$SA4_GCC_NAME16))
...
```{r include=FALSE}
coast_bin_sa1 <- read_csv("./data/airdna/raw/Spatial_join/coast_bin_sa1.zip",
