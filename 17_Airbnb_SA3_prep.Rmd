...
monthly_select %<>% 
  dplyr::filter(!property_id %in% unique(inactive_monthly$property_id))
```

Second, `r comma(nrow(inactive_monthly))` records 
of `r comma(length(unique(inactive_monthly$property_id)))` inactive properties were excluded. 
