...
View(filter(monthly_new_prep_rent, property_id == 27554784))
...
`r comma(nrow(monthly_new_prep_rent %>% filter(bedrooms == 0) %>% select(property_id) %>% distinct()))` roperties with 0 bedrooms were recoded to have 1. 
