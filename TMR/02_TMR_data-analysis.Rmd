...
Total number of listings operating in a given month across the whole study are of Qld and NNSW.
...
The lowest value of `r comma(min(airbnb_sa2_month_agg$supply))` was recorded on `r airbnb_sa2_month_agg %>% filter(supply == min(airbnb_sa2_month_agg$supply)) %>% select(reporting_month)`, the highest `r comma(max(airbnb_sa2_month_agg$supply))` was recorded on `r airbnb_sa2_month_agg %>% filter(supply == max(airbnb_sa2_month_agg$supply)) %>% select(reporting_month)`

\newpage

# Number of Airbnb bedrooms

Total number of bedrooms in listings operating in a given month across the whole study are of Qld and NNSW.
...
The lowest value of `r comma(min(airbnb_sa2_month_agg$mean_occupancy_rate))` was recorded on `r airbnb_sa2_month_agg %>% filter(mean_occupancy_rate == min(airbnb_sa2_month_agg$mean_occupancy_rate)) %>% select(reporting_month)`, the highest `r comma(max(airbnb_sa2_month_agg$mean_occupancy_rate))` was recorded on `r airbnb_sa2_month_agg %>% filter(mean_occupancy_rate == max(airbnb_sa2_month_agg$mean_occupancy_rate)) %>% select(reporting_month)`
