...
airbnb_sa2_supply_n %<>% 
  ...
  mutate(supply_n_rel = ifelse(supply_n == 0 & abs_supply == 0, 0, supply_n_rel)) %>% 
  mutate(supply_n_rel = ifelse(supply_n > 0 & abs_supply == 0, -999, supply_n_rel))
