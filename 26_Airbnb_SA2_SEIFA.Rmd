...
Starting point is set of `r number(nrow(SA2))` areas. This excludes 4 remote areas - three from Other Territories (but keeps one Jervis Bay!) and one from NSW (Lord Howe Island)
