...
ggplot(data, aes(x = rent_50p_int)) +
  geom_point(aes(y = m2_fit, size = n_listings_int), alpha = 0.5) +
...
ggplot(data, aes(x = rent_50p_int)) +
  geom_point(aes(y = m3_fit, size = n_listings_int), alpha = 0.5) +
  geom_line(aes(y = rent_50p_int), col = "darkorchid4") +
  theme_minimal() + xlab("Rent") + ylab("Predicted") 
...
ggplot(data, aes(x = rent_50p_int)) +
  geom_point(aes(y = m4_fit, size = n_listings_int), alpha = 0.5) +
  geom_line(aes(y = rent_50p_int), col = "darkorchid4") +
  theme_minimal() + xlab("Rent") + ylab("Predicted") 
...
ggplot(data, aes(x = rent_50p_int)) +
  geom_point(aes(y = m5_fit, size = n_listings_int), alpha = 0.5) +
  geom_line(aes(y = rent_50p_int), col = "darkorchid4") +
  theme_minimal() + xlab("Rent") + ylab("Predicted") 
...
m4_fit$adr_50p_int <- data$adr_50p_int
m4_fit$record_count <- data$record_count

m4_fit$diff <- (m4_fit$rent_50p_int - m4_fit$`0.5quant`) / m4_fit$rent_50p_int
...
```{r}
dotchart(c(m1$dic$dic, m2$dic$dic, m3$dic$dic, m4$dic$dic),
         labels = c("mod1", "mod2", "mod3", "mod4"), 
         main = "DIC")

dotchart(c(m1$waic$waic, m2$waic$waic, m3$waic$waic, m4$waic$waic),
         labels = c("mod1", "mod2", "mod3", "mod4"), 
         main = "WAIC")
